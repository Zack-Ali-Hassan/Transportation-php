...
$("#form_maintenance_report").on("submit", (event) => {
    generate=true;
  event.preventDefault();
  $("#table_maintenance_report tbody").html("");
  ...
  if (report_type != "All") {
    ...
    sending_data = {
      action: "read_maintenance_report",
      report_type,
      vehicle_id,
      start_date,
      end_date,
  ...
  $.ajax({
    method: "POST",
    dataType: "JSON",
    url: "../api/maintenance_report_api.php",
    data: sending_data,
    success: function (data) {
      ...
      if (status) {
        ...
        $("#table_maintenance_report tbody").append(tr);
      } else {
