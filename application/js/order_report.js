...
$("#form_order_report").on("submit", (event) => {
  generate =true;
  event.preventDefault();
  $("#table_order_report tbody").html("");
  let report_type = $("#report_type").val();
  let customer_id = $("#customer_id").val();
  let status_order = $("#status").val();
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (status) {
        ...
        $("#table_order_report tbody").append(tr);
      } else {
