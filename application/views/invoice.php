    ...
    <div class="col-lg-12 d-flex align-items-strech">
      <div class="card w-100">
        ...
        <div class="d-sm-flex d-flex align-items-center justify-content-between mb-9" style="border-bottom : solid 2px black">
            ...
            <h5 class="card-title fw-semibold">Invoice Table</h5>
            </div>
            <div>
            <button class="btn btn-outline-primary float-right mt-4 mb-5" type="submit" id="btn_add_invoice">Add New Invoice</button>
            </div>
          </div>
          ...
          <div class="modal" tabindex="-1" role="dialog" id="modal_invoice">
