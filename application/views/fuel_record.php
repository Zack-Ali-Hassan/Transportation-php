        ...
        <div class="card-body">
          <div class="d-sm-flex d-flex align-items-center justify-content-between mb-9" style="border-bottom : solid 2px black">
            <div class="mb-3 mb-sm-0">
              <h5 class="card-title fw-semibold">Fuel record Table</h5>
            </div>
            <div>
              <button class="btn btn-outline-primary float-right mt-4 mb-5" type="submit" id="btn_add_fuel_record">Add New Fuel</button>
            </div>
          </div>


          <div class="table-responsive">
            <table class="table" id="table_fuel_record">
              <thead>
                <tr>
                  <th>#</th>
                  <th>Fuel Type</th>
          ...
          <div class="modal" tabindex="-1" role="dialog" id="modal_fuel_record">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Fuel record Information</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form id="form_fuel_record">
                    ...
                    <div class="mb-3">
                      ...
                      <input id="quantity" type="text" class="form-control quantity" placeholder="Enter quantity">
                    </div>
                    <div class="mb-3">
...
<script src="../js/fuel_record.js"></script>